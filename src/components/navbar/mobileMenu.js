...
const MobileMenu = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full h-full z-50 bg-colorPrimario transform ${
    ...
    >
      ...
      <div className="flex flex-col text-white gap-y-3 textsml mx-6 mt-16">
        <button
          className="flex items-center gap-x-2 py-2 border-b border-lineColorBorder transform transition-all duration-300 hover:scale-105 font-semibold hover:text-blue-700 text-blue-950"
